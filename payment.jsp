...
<body>
  ...
  <div class="m-5">
    <div class="bg-white container">
        <div class="ms-3">
            <button class="btnreset fw-bold fs-1 " onclick="location.href='detail.jsp'"><img src="/static/img/chevron-left.svg" width="14px"></button>
          ...
          <div class="m-3">
            ...
            <div class="mb-4">
                <div>
                    ...
                    <p class="fw-normal">3월 3일 ~ 5일</p>
                </div><br>
                <div>
                    <p class="fw-bold">게스트</p>
                    <p class="fw-normal">게스트 2명</p>
                </div>
            </div>
            <hr>
            <!-- 결제 수단 -->
        ...
        <div class="col-5">
          <form class="bg-white rounded1 p-4 sticky1 border" style="width: 400px; height: 420px;">
            <div class="mb-3">
                ...
                <div class="fss">${hotels.hotel_name}</div>
		</c:forEach>
            </div>
            <hr>
            <div>
            ...
            <div>
              ...
              <span class=" fs-5 float-end">₩307,000</span>
            </div>
            <hr>
            <div>
